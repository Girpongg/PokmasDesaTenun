                ...
                <div class="relative flex-auto p-4" data-te-modal-body-ref>
                    ...
                    <div class="flex gap-x-4">
                        ...
                        <div class="relative mb-4" data-te-input-wrapper-init>
                            <input type="text"
                                class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                id="edit-unit" name="unit" placeholder="unit" />
                            <label for="edit-unit"
                                class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none">
                                Satuan
                            </label>
                    ...
                    <div class="mb-4 w-full">
                        <label for="edit-" class="ml-1">Tanggal Pembelian</label>
                        <input type="date" class="rounded-md w-full" id="edit-order_date">
                    </div>
                    <div class="relative mb-4" data-te-input-wrapper-init>
                        <input type="text"
                            class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                            id="edit-category" name="category" placeholder="category" />
...
@section('script')
    <script>
        ...
        const instance = new te.Datatable(
            customDatatable, {
                ...
                rows: data.map((expenditure, i) => {
                    ...
                    return {
                        ...expenditure,
                        price: 'Rp' + expenditure.price.toLocaleString('id-ID'),
                        quantity: expenditure.quantity + ' ' + expenditure.unit,
                        order_date: new Date(expenditure.order_date).toLocaleDateString('id-ID', {
                            weekday: 'long',
                            year: 'numeric',
                            month: 'long',
                            day: 'numeric'
        ...
        <div class="flex">
            ...
            data-quantity="${expenditure.quantity}" 
            data-unit="${expenditure.unit}" 
            data-price="${expenditure.price}" 
            data-category="${expenditure.category}" 
            data-description="${expenditure.description}" 
            data-order_date="${expenditure.order_date}" 
        ...
        function deleteExpenditure(expenditure_id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const url = `{{ route('expenditure.delete', '') }}/${expenditure_id}`;
                    $.ajax({
                        url: url,
                        method: 'DELETE',
                        headers: {
