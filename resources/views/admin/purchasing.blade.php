...
<script>
    $(document).ready(function () {
        $('#submit').on('click', async function (e) {
            ...
            // Collect product data from dynamically added products
            var products = [];
            ...
            return {
                ...
                actions: `
                    <div class="flex">
                        ...
                        <button data-te-ripple-init data-te-ripple-color="light" onclick=""
                            class="mr-3 btn-detail block rounded bg-success px-6 pb-2 pt-2.5 text-xs text-center font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#14a44d] transition duration-150 ease-in-out hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:outline-none focus:ring-0 active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)]">
                            Detil
                        </button>
...
<script>
    // When the "Add Product" button is clicked, show the modal
