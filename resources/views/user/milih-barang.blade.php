...
@section('content')
    <div class="container mx-auto my-10 px-5">
        <div class="text-center mb-10">
            ...
            <p class="text-[rgb(92,64,51)] font3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt</p>
        </div><a href=" {{ route('cart') }}">
            <button class="fixed z-50 bottom-4 right-4 bg-gray-200 hover:bg-gray-500 p-3 rounded-full shadow-2xl">
        ...
        <div class="grid grid-cols-5 px-12 place-items-center">
            @foreach ($catalog as $item)
                <div
                class="relative w-[250px] h-[310px] shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-md grid grid-rows-7"
                ...
                <div class="row-span-7 flex flex-col gap-1">
                    <img src="{{ asset('storage/uploads/catalog/' . $item->image) }}" alt="Image"
                        ...
                        <div class="pt-2 px-4 ">
                            ...
                            <h1 class="font3 leading-5 mt-2 text-[12px] text-red-100">Stok Tersisa {{ $item->stock }} pcs</h1>
                        </div>
                        <a class="flex justify-center" href="{{ route('add-cart', $item->id)}}">
                            <button class="rounded-md font4 w-full inline-block !bg-[#dfdfdf] m-4 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-black shadow-2xl transition duration-150 ease-in-out focus:shadow-md focus:outline-none focus:ring-0  active:shadow-primary-2 motion-reduce:transition-none dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong">
                                Masukkan ke Tas
                            </button>
                        </a>
                </div>
